...
public class Metodos {
    ...
    while (!DatoValido) {
      try {
        ...
        JO.showMessageDialog(
          null,
          "ERROR: Ingrese un valor valido, Error de Java: " + e
        );
      }
    }
  ...
  public void DivisionEntreCero() {
    ...
    while (!DatoValido) {
      try {
        b = Integer.parseInt(
          JO.showInputDialog("Dame el valor del denominador")
        );
        DatoValido = true;
        ...
        JO.showMessageDialog(
          null,
          "No se puede dividir entre 0 Error Java: " + e
        );
        DivisionEntreCero();
      }
    }
